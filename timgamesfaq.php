...
$sql = $db->prepare("SELECT * FROM faq where id=41");
$sql->execute(); 
$query_result = $sql->fetchAll();
$q1 = $query_result[0];

$sql = $db->prepare("SELECT * FROM faq where id=42");
$sql->execute(); 
$query_result = $sql->fetchAll();
$q2 = $query_result[0];

$sql = $db->prepare("SELECT * FROM faq where id=43");
$sql->execute(); 
$query_result = $sql->fetchAll();
$q3 = $query_result[0];

$sql = $db->prepare("SELECT * FROM faq where id=44");
$sql->execute(); 
$query_result = $sql->fetchAll();
$q4 = $query_result[0];


$sql = $db->prepare("SELECT * FROM faq where id=45");
$sql->execute(); 
$query_result = $sql->fetchAll();
$q5 = $query_result[0];

$sql = $db->prepare("SELECT * FROM faq where id=46");
$sql->execute(); 
$query_result = $sql->fetchAll();
$q6 = $query_result[0];

$sql = $db->prepare("SELECT * FROM faq where id=47");
$sql->execute(); 
$query_result = $sql->fetchAll();
$q7 = $query_result[0];

$sql = $db->prepare("SELECT * FROM faq where id=48");
$sql->execute(); 
$query_result = $sql->fetchAll();
$q8 = $query_result[0];

$sql = $db->prepare("SELECT * FROM faq where id=49");
$sql->execute(); 
$query_result = $sql->fetchAll();
$q9 = $query_result[0];

$sql = $db->prepare("SELECT * FROM faq where id=50");
$sql->execute(); 
$query_result = $sql->fetchAll();
$q10 = $query_result[0];
?>
...
<html lang="en">
  <head>
    ...
    <link href="timgamesfaq.css" rel="stylesheet">
  ...
  <body>
    ...
    <p>
    <a href="category-of-services.html">Category of Services</a> > <a href="tv-entertainment.html">TV & Entertainment</a> > <a href="timgames.html">TIM Games</a> > TIM Games FAQ
    </p>      
    </div>  
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse1" class="panel-collapse collapse in">
      <div class="panel-body"><?php echo $q1['answer'] ?></div>
    </div>
  </div>
  <div class="panel panel-default">
    <div class="panel-heading">
