...
<html lang="en">
  <head>
    ...
    <title>TIM Reading - Description</title>
    ...
    <link href="timreadingdescription.css" rel="stylesheet">
  ...
  <body>
    ...
    <p>
    <a href="category-of-services.html">Category of Services</a> > <a href="tv-entertainment.html">TV & Entertainment</a> > <a href="timreading.html">TIM Reading</a> > TIM Reading Description
    </p>      
    </div>
  ...
  <li class="active"><a href="#">QUOTIDIANI</a></li>
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide"  src="ImmaginiTIM/timreadingdesc2.png" alt="First slide">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide" src="ImmaginiTIM/gazzetta.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
            </div>
          </div>
        ...
        <div class="item">
          <img class="third-slide" src="ImmaginiTIM/gazzettino.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
            </div>
          </div>
...
<h2>Learn More...</h2>
<p><a class="btn btn-primary btn-lg" href="timreadingactrules.html" role="button">Activation & Rules &raquo;</a></p>
          </div>
           </div>
